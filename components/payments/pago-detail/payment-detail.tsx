...
import { Check, Edit, Loader2, X, BookOpen, CreditCard } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow border">
        <CardHeader className="p-4 bg-primary/5 border-b space-y-0">
        ...
        <CardContent className="p-0">
          <div className="p-4">
            {/* Tabla de Desglose por Disciplina */}
      ...
      <Card className="shadow border">
        ...
        <CardContent className="p-0">
          <div className="p-4">
            ...
            <table className="w-full text-sm rounded-lg border">
              <tbody className="divide-y divide-border">
                {/* Monto Base Total */}
