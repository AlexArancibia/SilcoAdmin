...
async function main() {
  ...
  const disciplinas = [
    {
      nombre: "Síclo", // Cambiado de Siclo a Síclo
      ...
      parametros: {
        formula: {
          ...
          descripcion: "",
          fechaCreacion: "2025-03-24T09:09:12.621Z",
          nodoResultado: "resultNode-1742807358541",
          fechaActualizacion: "2025-03-24T09:09:21.387Z",
        },
        duracionClase: 45,
        capacidadMaxima: 30,
      ...
      parametros: {
        formula: {
          ...
          conexiones: [
            ...
            {
              id: "reactflow__edge-numberNode-1742768244043output-operationNode-1742768122739a",
              origen: "numberNode-1742768244043",
              destino: "operationNode-1742768122739",
              puntoSalida: "output",
              puntoEntrada: "a",
            ...
            {
              id: "reactflow__edge-variableNode-1742768119449output-operationNode-1742768122739a",
              origen: "variableNode-1742768119449",
              destino: "operationNode-1742768122739",
              puntoSalida: "output",
              puntoEntrada: "a",
          ...
          descripcion: "",
          fechaCreacion: "2025-03-23T22:15:04.612Z",
          nodoResultado: "resultNode-1742768184651",
          fechaActualizacion: "2025-03-24T08:25:50.723Z",
        },
        duracionClase: 60,
        capacidadMaxima: 20,
    ...
    },
    {
      ...
      parametros: {
        formula: {
          ...
          descripcion: "",
          fechaCreacion: "2025-03-24T21:36:53.107Z",
          nodoResultado: "resultNode-1742852269261",
          fechaActualizacion: "2025-03-24T21:37:55.075Z",
        },
        duracionClase: 75,
        capacidadMaxima: 25,
        nivelDificultad: "Todos los niveles",
      },
      activo: true,
    },
    {
      ...
      parametros: {
        formula: {
          ...
          descripcion: "",
          fechaCreacion: "2025-03-24T08:15:15.444Z",
          nodoResultado: "resultNode-1742804143621",
          fechaActualizacion: "2025-03-24T08:15:51.521Z",
        },
        duracionClase: 50,
        capacidadMaxima: 15,
  ...
  // Crear periodos para 2025 (actualizados según el nuevo esquema)
